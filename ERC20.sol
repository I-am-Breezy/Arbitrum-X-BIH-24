...
contract ERC20 {
    string public name = "PEPPE"; // Token Name
    string public symbol = "PEP"; // Token Symbol
    uint public constant DECIMAL = 18; // Token decimal
    uint256 private totalSupply = 1_000_000_000; // Total Supply of Token to be in circulation
